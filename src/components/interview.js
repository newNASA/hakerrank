...
function Interview() {
    ...
    return (
        <div className='interview'>
            <div className='top'>
                <h1>Interview like it’s <span>2024</span></h1>
            ...
            <div className='bottom'>
                ...
                <div className='img'>
                    <img src="https://www.hackerrank.com/wp-content/uploads/2024/01/interview-2.png" alt=""/>
                </div>
            </div>
            ...
            <div className='about'>
                ...
                <div className='right'>
                    <div className='fixer' style={{ transform: `translateX(${position}px)` }}>
